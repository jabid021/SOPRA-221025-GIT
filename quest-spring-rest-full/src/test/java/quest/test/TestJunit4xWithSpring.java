...
public class TestJunit4xWithSpring {
	...
	public void stagiaireFindAllByFiliere() {
		...
		Stagiaire thomas = new Stagiaire("OURLIAC", "Thomas", "thomas@gmail.com", null);
		thomas = daoStagiaire.save(thomas);

		Stagiaire manon = new Stagiaire("BONNIN", "Manon", "manon@gmail.com", null);
		manon = daoStagiaire.save(manon);

		Stagiaire ilham = new Stagiaire("BOUTOUAL", "Ilham", "ilham@gmail.com", null);
		...
		// ASSERT
		Assert.assertEquals(0, stagiaires.size());
